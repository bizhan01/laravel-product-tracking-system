...
<div class="content-area py-1">
	<div class="container-fluid">
		<div class="box box-block bg-white">
			<h5>ویرایش مشخصات دارو</h5>
			<form action = "/updateDrug/<?php echo $product[0]->id; ?>" method = "post" enctype="multipart/form-data" >
					<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label>اسم دارو<span style="color: red">*</span></label>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>نوع دارو<span style="color: red">*</span></label>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>کد دارو<span style="color: red">*</span></label>
					...
					<div class="row">
						<div class="col-md-12">
							<label  style="color: black">تصویر دارو</label>
							<input type="hidden" name="productImage" value="<?php echo $product[0]->productImage; ?>">
							<input type="file" name="productImage" id="input-file-now-custom-1" class="dropify" data-default-file="/UploadedImages/drugs/<?php echo $product[0]->productImage; ?>" />
						</div>
				</div>
					<br>
